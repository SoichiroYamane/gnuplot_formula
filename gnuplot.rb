class Gnuplot < Formula
  ...
  def install
    ...
    if OS.mac?
      ...
      wx_cflags = "-I#{Formula['wxwidgets'].opt_include}"
      wx_libs = "-L#{Formula['wxwidgets'].opt_lib} -lwx_osx_cocoau-3.2"
    ...
    ENV['WX_CONFIG'] = Formula['wxwidgets'].opt_bin / 'wx-config'
    ENV.append 'CXXFLAGS', '-std=c++17' # needed for Qt 6
    ENV.append 'CPPFLAGS', "-I#{Formula['wxwidgets'].opt_include}"
    ENV.append 'LDFLAGS', "-L#{Formula['wxwidgets'].opt_lib}"
